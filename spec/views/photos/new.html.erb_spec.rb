...
describe "photos/new" do
  ...
  it "renders new photo form" do
    render
    user = User.create!(id: 1, username: "MyString", email: "MyString@email.com", password: "abc123", password_confirmation: "abc123")
    photo = Photo.create!(id: 1, path: "MyString", file_name: "MyString")
